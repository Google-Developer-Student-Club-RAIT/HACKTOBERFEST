...
# Submit your PR on this  repo  ,  we are merging all PR. 
...
- [Hacktoberfest Intro](https://www.youtube.com/watch?v=_V8_plBYHk4)
...
- You are allowed to make pull requests . We will review it and merge it ;)
...
```terminal
git clone https://github.com/Google-Developer-Student-Club-RAIT/HACKTOBERFEST.git
```
...
```terminal
git remote add upstream https://github.com/Google-Developer-Student-Club-RAIT/HACKTOBERFEST.git
```
